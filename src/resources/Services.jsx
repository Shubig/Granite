      ...
      <ErrorBoundary>
        ...
        >
         ...
         <div className=" flex flex-wrap justify-center gap-10">
          <img src="/Tile1.jpg"className="w-50 "/>
          <img src="/Tile2.jpg"className="w-50 "/>
          <img src="/Tile3.jpg"className="w-50 "/>
          <img src="/Tile4.jpg"className="w-50 "/>
         </div>
      ...
      <ErrorBoundary>
        ...
        >
          <h2 className="text-xl font-bold mb-2">DELIVERY LOGISTICS</h2>
           <div className=" flex flex-wrap justify-center gap-10">
            <img className=" w-200 h-50" src="/Delivery.jpg"/>
           </div>
...
<div className=" flex flex-wrap justify-center gap-30">
          <img src="/Tileout.jpg"className="w-60 "/>
          <img src="/Tileground.jpg"className="w-60 "/>
         </div>
      ...
      <ErrorBoundary>
        ...
        >
         ...
         <div className=" flex flex-wrap justify-center gap-10">
            <img className=" w-200 h-50" src="/Bulk.jpg"/>
           </div>
